...
select concat(c.first_name, ' ' ,c.last_name) as customerName, r.rental_date, f.title as film_title
from customer as c
join rental as r
...
-- Display the first name, last name, and email of customers along with the rental date, film title, nd rental return date.
...
JOIN address a2 
ON a1.city = a2.city AND a1.address_id != a2.address_id
JOIN customer c2 
